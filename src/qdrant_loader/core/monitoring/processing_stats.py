...
class ProcessingStats:
    ...
    def update_rates(self, num_documents: int, num_chunks: int, processing_time: float) -> None:
    ...
    def update_source_metrics(self, source: str, num_documents: int, processing_time: float) -> None:
