...
class IngestionMonitor:
    ...
    def start_operation(self, operation_id: str, metadata: Optional[Dict] = None) -> None:
    ...
    def start_batch(self, batch_id: str, batch_size: int, metadata: Optional[Dict] = None) -> None:
