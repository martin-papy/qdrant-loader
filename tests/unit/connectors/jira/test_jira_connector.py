...
def mock_env_vars():
    ...
    with patch.dict(os.environ, {"JIRA_TOKEN": "test_token", "JIRA_EMAIL": "test@example.com"}):
        yield
...
def test_parse_issue_with_parent(connector):
    ...
    raw_issue = {
        ...
        "fields": {
            ...
            "updated": "2024-01-01T00:00:00.000+0000",
            "parent": {"key": "TEST-0"},
            "reporter": {"accountId": "123", "displayName": "Test User"},
        },
    }
...
def test_parse_issue_with_linked_issues(connector):
    ...
    raw_issue = {
        ...
        "fields": {
            ...
            "created": "2024-01-01T00:00:00.000+0000",
            "updated": "2024-01-01T00:00:00.000+0000",
            "issuelinks": [{"type": {"name": "Blocks"}, "outwardIssue": {"key": "TEST-2"}}],
            "reporter": {"accountId": "123", "displayName": "Test User"},
        },
    }
...
async def test_get_documents(config, mock_jira_issue):
    ...
    with patch.dict(os.environ, {"JIRA_TOKEN": "test-token", "JIRA_EMAIL": "test@example.com"}):
        ...
        connector.client.jql.assert_called_once_with(
            'project = "TEST"', limit=50, start=0  # Default page size
        )
