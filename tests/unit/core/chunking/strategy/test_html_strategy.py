...
from qdrant_loader.core.chunking.strategy.html_strategy import HTMLChunkingStrategy, SectionType
...
class TestHTMLChunkingStrategy:
    ...
    def test_extract_title_from_content(self, html_strategy):
        ...
        title = html_strategy._extract_title_from_content("This is a sentence. This is another.")
        assert title == "This is a sentence"

        # Test long content
        long_content = "This is a very long piece of content that exceeds fifty characters"
