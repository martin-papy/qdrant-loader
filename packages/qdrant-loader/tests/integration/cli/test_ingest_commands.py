...
class TestIngestBasicFunctionality:
    ...
    def test_ingest_single_file(self, mock_neo4j, mock_qdrant, 
    ...
    @patch('qdrant_loader.core.managers.qdrant_manager.QdrantManager')
    def test_ingest_directory(self, mock_qdrant, 
                             cli_runner: CliRunner, cli_app,
                             workspace_with_config: Path, temp_workspace: Path):
    ...
    def test_ingest_missing_file(self, cli_runner: CliRunner, cli_app, temp_workspace: Path):
...
class TestIngestWorkspaceIntegration:
    ...
    def test_ingest_with_workspace_config(self, cli_runner: CliRunner, cli_app,
                                         workspace_with_config: Path, sample_document_file: Path):
    ...
    def test_ingest_legacy_config_mode(self, cli_runner: CliRunner, cli_app,
                                      temp_workspace: Path, sample_document_file: Path):
...
class TestIngestOptions:
    ...
    def test_ingest_batch_size_option(self, cli_runner: CliRunner, cli_app,
                                     workspace_with_config: Path, sample_document_file: Path):
    ...
    def test_ingest_dry_run_option(self, cli_runner: CliRunner, cli_app,
                                  workspace_with_config: Path, sample_document_file: Path):
    ...
    def test_ingest_verbose_option(self, cli_runner: CliRunner, cli_app,
                                  workspace_with_config: Path, sample_document_file: Path):
    ...
    def test_ingest_force_option(self, cli_runner: CliRunner, cli_app,
                                workspace_with_config: Path, sample_document_file: Path):
...
class TestIngestErrorHandling:
    ...
    def test_ingest_invalid_config(self, cli_runner: CliRunner, cli_app,
                                  temp_workspace: Path, sample_document_file: Path):
    ...
    def test_ingest_connection_error(self, cli_runner: CliRunner, cli_app,
                                    workspace_with_config: Path, sample_document_file: Path):
    ...
    def test_ingest_permission_error(self, cli_runner: CliRunner, cli_app, temp_workspace: Path):
...
class TestIngestAsyncOperations:
    ...
    @patch('qdrant_loader.core.managers.qdrant_manager.QdrantManager')
    @patch('qdrant_loader.core.managers.neo4j_manager.Neo4jManager')
    def test_ingest_async_processing(self, mock_neo4j, mock_qdrant,
                                    cli_runner: CliRunner, cli_app,
                                    workspace_with_config: Path, sample_document_file: Path):
    ...
    def test_ingest_concurrent_processing(self, cli_runner: CliRunner, cli_app,
                                         workspace_with_config: Path, temp_workspace: Path):
        ...
        for i in range(5):
            ...
            doc_file.write_text(f"Concurrent document {i} for testing parallel processing.")
        ...
        with patch('qdrant_loader.core.managers.qdrant_manager.QdrantManager'):
            result = cli_runner.invoke(cli_app, [
                ...
                str(docs_dir),
                '--workspace', str(workspace_with_config),
                '--workers', '2'  # If such option exists
            ])
...
class TestIngestProgressTracking:
    ...
    def test_ingest_progress_display(self, cli_runner: CliRunner, cli_app,
                                    workspace_with_config: Path, temp_workspace: Path):
    ...
    def test_ingest_quiet_mode(self, cli_runner: CliRunner, cli_app,
                              workspace_with_config: Path, sample_document_file: Path):
...
class TestIngestFileTypes:
    ...
    def test_ingest_text_files(self, cli_runner: CliRunner, cli_app,
                              workspace_with_config: Path, temp_workspace: Path):
    ...
    def test_ingest_unsupported_files(self, cli_runner: CliRunner, cli_app,
                                     workspace_with_config: Path, temp_workspace: Path):
