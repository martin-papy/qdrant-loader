...
class TestCoreCLI:
    ...
    def test_cli_with_workspace_option(self, cli_runner: CliRunner, cli_app, temp_workspace: Path):
...
class TestCLIErrorHandling:
    ...
    def test_missing_config_error(self, cli_runner: CliRunner, cli_app, temp_workspace: Path):
...
class TestCLIEnvironmentIsolation:
    ...
    def test_cli_without_env_variables(self, cli_runner: CliRunner, cli_app, isolated_environment):
    ...
    def test_cli_with_custom_env(self, cli_runner: CliRunner, cli_app, isolated_environment):
...
class TestCLIWorkspaceIntegration:
    ...
    def test_workspace_detection(self, cli_runner: CliRunner, cli_app, workspace_with_config: Path):
    ...
    def test_workspace_creation(self, cli_runner: CliRunner, cli_app, temp_workspace: Path):
