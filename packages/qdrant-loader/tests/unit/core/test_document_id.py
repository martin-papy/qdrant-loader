...
class TestDocumentIdGeneration(unittest.TestCase):
            ...
            # Basic cases
            {
                ...
                "variations": [
                    ...
                    },
                    {
                        "source_type": " git ",
                        "source": " repo1 ",
                        "url": "https://example.com/doc?param1=value1",
                    },
                ],
            },
            # URL variations
    ...
    def test_id_consistency(self):
        ...
        for test_case in self.test_cases:
            ...
            base_id = Document.generate_id(
                test_case["source_type"], test_case["source"], test_case["url"]
            )
    ...
    def test_id_uniqueness(self):
        ...
        self.assertNotEqual(
            id1, id2, "Different source types should generate different IDs"
        )
