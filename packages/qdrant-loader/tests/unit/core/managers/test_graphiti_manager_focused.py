"""
Focused unit tests for GraphitiManager.

This test suite covers the core functionality of GraphitiManager
to improve coverage from 17% to 70%+.
"""
...
class TestGraphitiManagerFocused:
    """Focused tests for GraphitiManager core functionality."""
    ...
    def graphiti_manager(self, mock_graphiti_config, mock_neo4j_config):
        ...
        return GraphitiManager(
            graphiti_config=mock_graphiti_config, neo4j_config=mock_neo4j_config
        )
    ...
    @pytest.mark.asyncio
    async def test_initialize_success(self, graphiti_manager):
        ...
        with (
            ...
            patch(
                "qdrant_loader.core.managers.graphiti_manager.AsyncOpenAI"
            ) as mock_openai,
            patch(
                "qdrant_loader.core.managers.graphiti_manager.OpenAIEmbeddings"
            ) as mock_embeddings,
        ):
    ...
    async def test_initialize_failure(self, graphiti_manager):
        ...
        with patch(
            ...
            mock_graphiti_class.side_effect = Exception("Initialization failed")
    ...
    @pytest.mark.asyncio
    async def test_close_success(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_close_with_error(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_search_success(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_search_with_center_node(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_search_limit_enforcement(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_search_failure(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_nodes_specific_uuids(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_nodes_general_search(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_nodes_with_failure(self, graphiti_manager):
        """Test get_nodes with search failure for specific UUID."""
        mock_graphiti_client = AsyncMock()
        graphiti_manager._graphiti = mock_graphiti_client
        graphiti_manager._llm_client = Mock()
        graphiti_manager._embedder = Mock()

        # First call fails, should continue with warning
        mock_graphiti_client.search.side_effect = [
    ...
    @pytest.mark.asyncio
    async def test_get_edges_specific_uuids(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_edges_general(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_optimized_search_success(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_optimized_search_with_failure(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_search_performance_stats_success(self, graphiti_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_search_performance_stats_with_failure(self, graphiti_manager):
