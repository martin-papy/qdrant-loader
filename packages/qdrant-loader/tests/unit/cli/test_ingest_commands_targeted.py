...
class TestRunInitFunction:
    ...
    async def test_run_init_success(self, mock_settings):
        ...
        with (
            patch("qdrant_loader.cli.ingest_commands.init_collection") as mock_init,
            ...
            logger.info.assert_called_once_with(
                "Collection initialized successfully", collection="test_collection"
            )
    ...
    async def test_run_init_success_with_force(self, mock_settings):
        ...
        with (
            ...
            logger.info.assert_called_once_with(
                "Collection recreated successfully", collection="test_collection"
            )
...
class TestInitCommand:
    ...
    def test_init_database_directory_creation(self, runner, mock_settings):
        ...
        mock_settings.global_config.state_management.database_path = (
            "/tmp/nonexistent/test.db"
        )
        ...
        with (
            ...
            patch("qdrant_loader.cli.ingest_commands.run_init") as mock_run_init,
            patch(
                "qdrant_loader.cli.core.create_database_directory"
            ) as mock_create_dir,
...
class TestErrorHandling:
    ...
    def test_init_click_exception_handling(self, runner):
        ...
        with patch(
            "qdrant_loader.cli.ingest_commands.validate_workspace_flags"
        ) as mock_validate:
