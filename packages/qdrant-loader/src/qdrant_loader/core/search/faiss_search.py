...
class FAISSSearchService:
    ...
    def _initialize_index(self) -> None:
        ...
        try:
            ...
            if (
                not collection_info
                or not collection_info.config
                or not collection_info.config.params
            ):
    ...
    def _load_vectors(self) -> None:
        ...
        try:
            ...
            while True:
                ...
                if (
                    isinstance(self.index, faiss.IndexIVFFlat)
    ...
    async def search(
        ...
        try:
            ...
            for distance, idx in zip(distances[0], indices[0], strict=False):
                ...
                if filter_conditions and not self._check_filters(
                    cast(dict[str, Any], point.payload), filter_conditions
                ):
                    continue
    ...
    def _check_filters(
        self, payload: dict[str, Any], filter_conditions: dict[str, Any]
    ) -> bool:
